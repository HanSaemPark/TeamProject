...
<div>
				...
				<div class="row">
					<div class="col-lg-8 mx-auto">
						<div class="modal-body">
							...
							<h2 class="text-uppercase">LoalPage</h2>
							<p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
							<!-- ---------------------------------------------------------------------- -->
							<!-- 지역 이미지 -->
							<div class="row">
								<c:forEach var="item" items="${localData}" varStatus="view">
									<c:set var="i" value="${view.count}"/>
									<div class="col-md-4 col-sm-6 portfolio-item">
										<a class="portfolio-link" data-toggle="modal" href="#localData${i}"> 
	...
	<c:forEach var="item" items="${localData}" varStatus="view">
		...
		<div class="portfolio-hover">
			...
			<!-- Modal 경상도 세부 1 -->
			<div class="portfolio-modal modal fade" id="localData${i}" tabindex="-1" role="dialog" aria-hidden="true">
							...
							<div class="row">
								<div class="col-lg-8 mx-auto">
									<div class="modal-body">
										...
										<a class="btn btn-success" data-toggle="modal" href="#localData${i}" type="submit" >
											<i class="fa fa-times"></i>Close Project
										</a>
										<div class="card my-4">
