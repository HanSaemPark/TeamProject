...
System.out.println("RealPath : "+context.getRealPath("resources/boardDesign/ps_design/editor/upload"));
String path = context.getRealPath("resources/boardDesign/ps_design/editor/upload");
